...
<body>
    ...
    <div id="app" class="QYZX">
        <div data-v-68cd18ac="">
            <div data-v-68cd18ac="" class="van-nav-bar van-hairline--bottom" style="color: rgb(255, 255, 255) !important;">
                    ...
                    <div data-v-68cd18ac="" class="withdraw-box">
                        <div data-v-68cd18ac="" class="item-block mg-btm15">
                            <div data-v-68cd18ac="" class="van-cell van-field">
                                <div data-v-68cd18ac="" class="van-cell__title van-field__label"><label data-v-68cd18ac="" id="van-field-1-label" for="van-field-1-input">VND</label>
                                </div>
                                <div data-v-68cd18ac="" class="van-cell__value van-field__value">
                                    <div data-v-68cd18ac="" class="van-field__body"><input data-v-68cd18ac="" type="text" inputmode="decimal" id="van-field-1-input" placeholder="Nhập số tiền rút tiền" aria-labelledby="van-field-1-label" class="van-field__control"></div>
                                </div>
                            </div>
                                ...
                                <div data-v-68cd18ac="">
                                    <div data-v-68cd18ac="" class="fz14 text-rgt">
                                        <div data-v-68cd18ac="" class="van-cell van-field" style="padding: 0px;">
                                            <div data-v-68cd18ac="" class="van-cell__value van-field__value">
                                                <div data-v-68cd18ac="" class="van-field__body"><input data-v-68cd18ac="" type="password" id="van-field-2-input" placeholder="Mật khẩu quỹ" class="van-field__control van-field__control--right"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
