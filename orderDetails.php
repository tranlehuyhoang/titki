                ...
                <div>
                    <div class="detail-main">
                        <div style="position: absolute; right: -2px; top: -4px; width: 90px; height: auto;"><img
                                ...
                                alt="" style="width: 100%;"></div><img alt=""
                            src="https://tafr1b.com//upload/3ff53f4b8d31c96b/e970da55e1b0c33f.png" class="imgs">
                        <div class="fz16 col-055 font-wgh"> váy yếm lụa dáng dài 3 màu xinh xắn </div>
                        ...
                        <div class="money-box">
                            <div class="d-flex flex-align-center flex-justify-between line-ht money-item">
                                ...
                                <div class="fz16 col-fa0"> VND 89,000 </div>
                            </div>
                            <div class="d-flex flex-align-center flex-justify-between line-ht money-item">
                                <div class="fz16 col-0c5">Tiền lợi nhuận</div>
                                <div class="fz16 col-fa0"> VND 13,350 </div>
                            </div>
                            <div class="d-flex flex-align-center flex-justify-between line-ht money-item">
                                <div class="fz16 col-0c5">Số tiền phải trả lại</div>
                                <div class="fz16 col-fa0"> VND 102,350 </div>
                            </div>
                            <div class="d-flex flex-align-center flex-justify-between line-ht money-item"
                                style="display: none;">
                                <div class="fz16 col-0c5"> Số tiền phải trả lại </div>
                            ...
                            <div class="d-flex flex-align-center flex-justify-between line-ht money-item">
                                ...
                                <div class="fz16 col-fa0"> 09:46:57 1/4/2024 </div>
                            </div>
                            <div class="d-flex flex-align-center flex-justify-between line-ht money-item">
                                <div class="fz16 col-0c5">Trạng thái đặt hàng</div>
                                <div class="fz16 col-fa0"> Đang chờ xử lí </div>
                            </div>
                        </div>
                    </div>
                    <div class="btn-box">
